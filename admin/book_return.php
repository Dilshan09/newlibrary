       ...
       <div class="card">
        ...
        <form method = "post">
            ...
            <div class="mb-3">
                ...
                oninput="this.setCustomValidity(parseInt(this.value) < 0 ? 'Student ID cannot be a negative value.' : ''); reportValidity();" required>
            </div>

            <div class="mb-3">
                <label>ISBN</label>
                <input type="number" class="form-control" placeholder="Enter ISBN no" name="isbn"
                    oninput="this.setCustomValidity(parseInt(this.value) < 0 ? 'ISBN cannot be a negative value.' : ''); reportValidity();" required>
            </div>
