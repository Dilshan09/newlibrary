                    ...
                    <div class="col-12">
                        ...
                        <div class="container my-5">
                            <form method="post">
                                <div class="mb-3">
                                    <label>ISBN</label>
                                    <input type="number" class="form-control" placeholder="Enter ISBN no" name="isbn" value=<?php echo $isbn; ?>><!-- to see default value -->
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" placeholder="Enter Published Year" name="year" value=<?php echo $year; ?>>
                                </div>
                                <div class="mb-3">
                                    <label>Book Category</label>
                                    <input type="text" class="form-control" placeholder="Enter Book Category" name="category" value=<?php echo $category; ?>>
                                </div>
                                <div class="mb-3">
                                    <label>Quentity</label>
                                    <input type="number" class="form-control" placeholder="Enter Quentity" name="quentity" value=<?php echo $quentity; ?>>
                                </div>
                                <div class="mb-3">
                                    <label>Author Name</label>
                                    <input type="text" class="form-control" placeholder="Enter Author Name" name="author" value=<?php echo $author; ?>>
                                </div>
                                <!-- auto complete on -->
